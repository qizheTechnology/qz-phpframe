...
<div style="float:left;">
    ...
    <form action="df_z_pass.php">
	<h1>
	<font style="color:red;font-size:20px">饭卡支出</font>
	</h1>
        <div>
        卡号： <select name="card">
		...
		金额：<input type="number" min="0" name="out_money"style="width:40px" />
		</div>
		<div>
		...
		<br>
		<button type="submit">提交</button><font style="color:red;font-size:12px">备注好充值电费的宿舍</font>
    </form>
</div>
</body>
</html>
